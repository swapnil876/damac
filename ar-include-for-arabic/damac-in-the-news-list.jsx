...
import { INTHENEWSLISTING } from '../../graphql-ar/inthenewslisting';
...
export const getServerSideProps = async () => {
  ...
  entitiy.map((v,i)=>{
    ...
    blogs.push({title:v.title,url:'damac-in-the-news/'+v.nid,imageUrl: v.fieldThumbnailDesktop.url,ctaText:'Read More',excerpt:v.body.value,  author: (v.fieldAuthor && v.fieldAuthor!=null) && v.fieldAuthor.entity.name, tag: v.fieldTag && v.fieldTag.entity.name})
  });
  // const blogs = [
  //     {
