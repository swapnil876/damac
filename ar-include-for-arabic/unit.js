...
import { faWhatsapp } from '@fortawesome/free-brands-svg-icons'
 ...
 import { LISTING } from '../../graphql-ar/listing';
                ...
                <section className={style['inner-wrap-hero']} style={{'backgroundImage': 'url(images/project-bg.jpg)'}}>
                    <div className={style['project-hero-wrap']}>
                        ...
                        <div className="row align-items-end">
                              ...
                              <a href="javascript:void(0)" style={{'width':'fit-content','font-family': 'Roboto','font-size': '16px','font-style': 'normal','font-weight': '300','line-height': '22px','letter-spacing': '0.02em','text-align': 'left','text-decoration': 'none','color': '#fff'}}><img src="damac-static/images/location.png"/>{entity.Address}, {entity.Country.display_value}</a>
                        ...
                        <div className="container">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className={style['vs-range']}>
                                    <h5><a href="javascript:void(0)">AED {entity.Unit_price_AED}</a></h5>
                                    <p>Starting from</p>
                                </div>
                                <div className={style['vs-range']}>
                                    <h5><a href="javascript:void(0)">{entity.Location}</a></h5>
                                    <p>Locality</p>
                                </div>
                                <div className={style['vs-range']}>
                                    <h5><a href="javascript:void(0)">{entity.Status}</a></h5>
                                    <p>Status</p>
                                </div>
                 ...
                 <section className={style['3d-tour']}>
                        ...
                        <div className={style['3d-tour-inner']} style={{'backgroundImage':'url(/images/3d-tour-listing.jpg)','backgroundRepeat': 'no-repeat', 'width': '100%', 'padding': '251px 2px', 'maxWidth':'100%'}}>
                          <div className={`${style["3d-content-inner"]} ${style["text-center"]}`}>
                            ...
                            <a href="javascript:void(0)" className="btn btn-primary"><img src="/damac-static/images/per.png" style={{'marginRight':'13px'}}/>Take a 3D Tour</a>
                          </div>
                        </div>
                        </div>
                      </section>
...
function useStickyState(defaultValue, key) {
 ...
 export async function getServerSideProps(context) {
  ...
  if(typeof data2 != 'undefined' &&  typeof data1 != 'undefined'){
    ...
    // const    = await client.query({ query: LISTING });
    
    let listingdata = {fieldCol1ImageDesktopL1:{entity:{}},fieldCol2Row1Col1ImageDesL:{entity:{}},fieldCol2Row1Col2ImageDesL:{entity:{}},fieldCol2Row2ImageDesktopL1:{entity:{}},fieldCol2Row2ImageDesktopL1:{entity:{}},fieldAmenitiesL:[],fieldGalleryDesktopL:[],fieldAboutTextL:{},fieldLocatorsL:[]};
