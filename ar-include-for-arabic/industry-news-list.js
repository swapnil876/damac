...
import { faWhatsapp } from '@fortawesome/free-brands-svg-icons'
 ...
 import { BLOGTYPEDETAIL } from '../../graphql-ar/master/blogtypedetail';
 ...
 export async function getServerSideProps(context){
  ...
  entitiy.map((v,i)=>{
    ...
    blogs.push({title:v.title,url:'/damac-in-the-news/'+v.nid,imageUrl: v.fieldThumbnailDesktop!=null && v.fieldThumbnailDesktop.url,ctaText:'Read More',excerpt:v.body!=null && v.body.value,  author: (v.fieldAuthor!=null && v.fieldAuthor.entity!=null) && v.fieldAuthor.entity.name, tag: (v.fieldTag.entity!=null && v.fieldTag!=null) && v.fieldTag.entity.name})
  });
  // Use this for footer
