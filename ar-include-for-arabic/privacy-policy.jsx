...
import { BASICPAGE } from '../../graphql-ar/master/basic_page';
  ...
  return (
    <div className='buildingdocumentationbody'>
      ...
      <main className="main buildingdocumentation-main">
           ...
           <PageTitle title={(page.fieldPageType!=null&&page.fieldPageType.entity!=null) && page.fieldPageType.entity.name}/>

           <section className="building-documentation-para">
             <div className="container" dangerouslySetInnerHTML={{ __html:page.body!=null && page.body.value }}>
...
export const getServerSideProps = async () => {
  ...
  const  data  = await client.query({ query: BASICPAGE,variables:{type:'45'} });
