...
import { _CSR } from '../../graphql-ar/csr';
    ...
    <div className='aboutbody'>
      ...
      {/* {entity1.fieldHeaderImageVideoDeskCs.entity.url} */}
       ...
       <TextSection className="text-section-csr-2 custom_black_color">         
           ...
           <div className="row align-items-center">
             ...
             <div className="col-md-4 order-md-2 order-1">
               <div className="text-md-end text-center py-2">
                 <img alt=""src={isMobile?entity1.fieldFoundationImageMobile!=null && entity1.fieldFoundationImageMobile.url:entity1.fieldFoundationImageDesktop!=null && entity1.fieldFoundationImageDesktop.url} className='img-responsive' style={isMobile ? {'margin-bottom':'30px'} : {}}/>
               </div>
             </div>
           </div>
         </div>
         ...
         {
           entity1.fieldSectionHeading!=null ? 
