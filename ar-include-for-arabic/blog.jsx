...
import { BLOGSLISTING } from '../../graphql-ar/blog_listing';
  ...
  return (
    <div className='bloglistbody'>
      ...
      <main className="main bloglist-main">
           ...
           <PageTitle title={header!=null && header.fieldPageTitleBlogs} backgroundImage='/damac-static/images/investor-relation-hero.jpg' />
