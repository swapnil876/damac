...
import {PROJECTSEARCH} from '../../graphql-ar/project-search';
import {PROJECT} from '../../graphql-ar/project';
import {COUNTRY} from '../../graphql-ar/master/country';
import {LOCATIONS} from '../../graphql-ar/master/location';
import {CITY} from '../../graphql-ar/master/cityjs';
                        ...
                        <div className="row">
                                ...
                                <div key={k} className="col-md-6">
                                    <div key={k} className={styles['property-slider-wrap']}>
                                        <div className={styles['project-card']}>
                                            <img src={project.fieldMainImageDesktopP && project.fieldMainImageDesktopP.url} className="img-fluid" />
                                            <h6>{project.title}</h6>
                                            <p>{project.fieldLocationP!=null?project.fieldLocationP.entity.name:''} </p>
                                            <ul className={styles['bedroom-detail']}>
                                                <li>
                                                    <a href="javascript:void(0)"><img src="damac-static/images/price-tag 1.png" className="img-fluid" />From AED {project.fieldStartingFromPriceP2}*</a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)"><img src="damac-static/images/house (2) 1.png" className="img-fluid" />{project.fieldAreaP2} sqft</a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)"><img src="images/icons/bed.png" className={`img-fluid ${styles["small_icons"]}`}/>{project.fieldBedRoomsP2} Bedrooms</a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)"><img src="images/icons/door.png" className={`img-fluid ${styles["small_icons"]}`}/>{project.fieldLocalityP2}</a>
                                                </li>
                                            </ul>
                            ...
                            <div className="col-md-12">
                                <div className="view_more_btn text-center">
                                    <a href="javascript:void(0)" className={styles['solid-icon']}>View more</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        {projectList.map((project,k) => (
                            <div key={k} className="col-md-3">
                                <div className={styles['property_similar_card']}>
                                    <img src={project.fieldMainImageDesktopP && project.fieldMainImageDesktopP.url} alt="similar-property-img" className="img-fluid" />
                                    <h2><a href="javascript:void(0)">{project.title}</a></h2>
