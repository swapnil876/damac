...
const ProjectLanding= ({projects,countries,cities,locations, nav, othernav, footerData})=> {
   ...
   async function getProjects(cp){
    ...
    if(typeof window != 'undefined')
        window.location.href = '/projects'+q;
    }
                                ...
                                <div key={k} className="col-md-6">
                                    <div key={k} className={styles['property-slider-wrap']}>
                                        <div className={styles['project-card']}>
                                            <img src={project.fieldMainImageDesktopP!=null?project.fieldMainImageDesktopP.url:''} className="img-fluid" />
                                            <h6>{project.title}</h6>
                        ...
                        {projectList.map((project,k) => (
                            <div key={k} className="col-md-3">
                                <div className={styles['property_similar_card']}>
                                    <img src={project.fieldMainImageDesktopP!=null?project.fieldMainImageDesktopP.url:''} alt="similar-property-img" className="img-fluid" />
