...
export async function getStaticProps(context) {
  ...
  press_item_list.map((v,i)=>{
    blogs.push({title:v.title,url:'/press-release/'+v.nid,imageUrl: v.fieldThumbnailDesktop.url,ctaText:'Read More',excerpt:v.fieldShortText, author: v.fieldAuthor.entity.name, tag: v.fieldTag.entity.name })
  });
