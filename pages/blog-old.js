                 ...
                 </div>
                 {
                   section1Data.map((m,n)=>(
                    <div className="news" key={n}>
                      ...
                      <h6><Link href="javascript:void(0)"><a href="javascript:void(0)" onClick={()=>{saveBlogItem(m)}}>{m.title}</a></Link></h6>
            ...
            <div className="row">
              {
                section1Data.map((m,n)=>
                  ...
                  //       {/* <span>Customer’s Stories</span> */}
                  //       <h5 className="card-title">
                  //       <Link href="javascript:void(0)"><a className="head_link" style={{'fontWeight':'500'}}>{m.title}</a></Link>
                  //       </h5>
                  //       <p className="card-text">{m.entityCreated} by {m.fieldAuthor!=null?m.fieldAuthor.entity.name:''}</p>
          ...
          <div className="row">
            {
              secThreeNewsList.map((item, index)=>(
                ...
                <div className="card card-for-news-page">
                   <img alt={item.title} src={deviceIsMobile ? (item.fieldFeatureImageMobile!=null?item.fieldFeatureImageMobile.url:'') : (item.fieldThumbnailDesktop!=null?item.fieldThumbnailDesktop.url:'') } className="card-img-top card-img-for-news-page " />
                   <div className="card-body">
                     <h5 className="card-title"><Link href={"damac-in-the-news" + "/" + item.nid}><a>{item.title}</a></Link></h5>
                     <p className="card-text">{(item.fieldAuthor!=null&&item.fieldAuthor!='')?item.fieldAuthor.entity.name:''}</p>
                   </div>
                 </div>
               </div>
              ))
