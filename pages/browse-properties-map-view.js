                                                ...
                                                </div>
                                                {
                                                    properties.map((item, index)=>(
                                                        ...
                                                        <div className={styles['project-card']}>
                                                            ...
                                                            <li><a href="#"><img src="/damac-static/images/bookmark.png" alt="bookmark"/></a></li>
                                                            </ul>
                                                            <h6>{item.title}</h6>
                                                            <p>{(item.fieldLocationP && item.fieldLocationP!=null) ? item.fieldLocationP.entity.name : ''}</p>
                                                            ...
                                                            <div className={styles['shape-contact']}>
                                                                ...
                                                                <li><a href={item.fieldWhatsapp && item.fieldWhatsapp} target="_blank" className={styles['solid-icon']}>
