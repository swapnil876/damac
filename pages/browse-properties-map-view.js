...
import Select from "react-dropdown-select";
                            ...
                            <Carousel className='carousel_card' responsive={responsive}>
                                {
                                     properties.map((item,key)=>(
                                        <div className='property-slider-wrap' key={key}>
                                          <div className={styles['project-card']}>
                                              ...
                                              <ul className="bedroom-detail">
                                                  <li>
                                                      <a href="javascript:void(0)"><img src="/damac-static/images/price-tag 1.png" className="img-fluid"/>From AED {item.fieldStartingFromPriceP2}*</a>
                                                  </li>
                                                  <li>
                                                      <a href="javascript:void(0)"><img src="/damac-static/images/house (2) 1.png" className="img-fluid"/>Villa {item.fieldBedRoomsP2} Bedrooms</a>
                                                  </li>
                                              </ul>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6 d-flex flex-wrap">
                                                        ...
                                                        <div className={styles['more-filter-btn']}>
                                                            <a href="javascript:void(0)">More filters <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span></span><span></span><span></span></a>
                                        ...
                                        <div className={styles['map_list_view']}>
                                            <ul className="list-unstyled d-flex">
                                                ...
                                                <li className={styles['active']}><a href="javascript:void(0)">Map</a></li>
                                            </ul>
                                        </div>                 
                                    </div>     
                                    </div> :  ''
                               ...
                               <div className="container" style={{'display':'flex'}}>
                                        <div className="col-md-5 px-0 sider-bar-overflow">
                                            <div className={styles['properties-sidebar-wrap']}>
                                                ...
                                                {
                                                    property.map((unit,key)=>(
                                                        (unit!=null && unit.entity!=null) &&
                                                        <div className={styles['property-slider-wrap']} key={key}>
                                                        <div className={styles['project-card']}>
                                                            <Carousel className={styles['slider']} responsive={responsive}>
                                                            {
                                                              imageSize.map((k,l)=>(
                                                            ...
                                                            <ul className={styles['bedroom-detail']}>
                                                                <li>
                                                                    <a href="javascript:void(0)"><img src="/damac-static/images/price-tag 1.png" className="img-fluid"/>From AED {unit.entity.Unit_price_AED}*</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0)"><img src="/damac-static/images/house (2) 1.png" className="img-fluid"/>Villa {unit.entity.Number_of_Bedrooms1} Bedrooms</a>
                                                                </li>
                                                            </ul>
 ...
 export const getServerSideProps = async (cp) => {
    ...
    await axios.get('https://creator.zoho.com/api/v2/shaily.verma_damacgroup/pim-property-inventory-management/report/Add_Property_Report?from=50&limit=60'+value,
        {
            headers:{
