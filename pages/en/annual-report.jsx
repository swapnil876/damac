...
import { ANNUALREPORTS } from '../graphql-ar/master/annual_reports';
...
export const getServerSideProps = async () => {
  ...
  var data;
    if(e.locale == 'en')
     data  = await client.query({ query: ANNUALREPORTS });
    else
      data = await client.query({ query: ARANNUALREPORTS});
  let entity1 = data.data.nodeQuery.entities.entityTranslation;
