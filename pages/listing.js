...
import { faWhatsapp } from '@fortawesome/free-brands-svg-icons'
 ...
 export default function Listing({mobileDevice}){
      ...
      <div className="col-md-6">
        <div className={style['shape-content-wrap']}>
          <div className={style['shape-item']}>
            ...
            <p><strong>Shaping the Middle East’s luxury real<br/> estate market since 2002</strong></p>
    ...
    <div className="row">
      <div className="col-6 col-md-4">
        <div className={`${style["distance-card"]} text-center`}> 
          <img src="damac-static/images/building.png"/>
          <h5>5 min</h5>
      ...
      <div className="col-6 col-md-4">
        <div className={`${style["distance-card"]} text-center`}> 
          <img src="damac-static/images/aeroplane 2.png"/>
          <h5>10 min</h5>
          <p>from Dubai International <br/>Financial Centre</p>
        </div>
      </div>
      <div className="col-12 col-md-4">
        <div className={`${style["distance-card"]} text-center`}> 
          <img src="damac-static/images/sunrise 1.png"/>
          <h5>13 min</h5>
