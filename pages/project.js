         ...
         <div className="Project">
          ...
          <div className={`container`}>
              <div className={`text-wrapper`}> 
                <div className="top-text">
                  <h2>The premier venue for best-in-class facilities</h2>
                  <p>Live your story amongst a spectacular mix of culture and leisure attractions that are sure to leave you astounded, and retreat to your luxurious haven whenever you want to take a break.  Live your story amongst a spectacular mix of culture and leisure attractions. 
                     That are sure to leave you astounded, and retreat to your luxurious haven whenever you want to take a break.</p>
                </div>

                <div className="section-data-boxes">
                <div className="data-box" style={{'width':'fit-content'}}>
                    <h2 className="heading-medium">Apartments - Townhouses - Villas</h2>
                    <p>Properties</p>
                  </div>
                  {/* <div className="data-box" style={{'width':'fit-content'}}>
          ...
          { !deviceIsMobile && 
            <div className={`containerRightImage`}>
              <img alt="" src='/images/textsection-right-1.jpg' layout='fill' objectFit="cover" style={{'max-width':'100%'}}/>
            </div>
          }
          { deviceIsMobile && 
        ...
        <div className={style['shape-detail']}>
                <div className="container">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className={style['vs-range']}>
                            <h5><a href="#">Ready to Move In</a></h5>
                            <p>Status</p>
                        </div>
                ...
                <div className={style['angry-grid']}>
                    ...
                    <img src="damac-static/images/project-gal1.jpg" className="img-fluid"/>
                    <div className={style['gal-content']}>
                        <p>A safe, gated neighbourhood, DAMAC Hills is ideally located on the crossroads between Dubai and Abu Dhabi. In addition to the 18-hole Championship golf course at its doorstep, DAMAC Hills is only a few moments away from the globally significant Expo 2021 and the Al Maktoum International Airport.</p>
                    </div>         
                    </div>
                    </div>
                    <div className={style['gr-item-1']}>
                        <div className={style['sm-gal-right']}>
                        <img src="damac-static/images/project-gal2.jpg" className="img-fluid"/>
                        </div>
                    </div>
                    <div className={style['gr-item-2']}>
                    <div className={style['sm-gal-left']}>
                        <img src="damac-static/images/project-gal3.jpg" className="img-fluid"/>
                        </div>
                    </div>
